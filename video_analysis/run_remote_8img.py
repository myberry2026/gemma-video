...
def extract_frames_b64(video_path, num_frames=8):
    ...
    for frame in frames:
        ...
        # Resize for faster transmission while keeping decent quality
...
def run_remote_inference(video_path, prompt):
    ...
    images_b64 = extract_frames_b64(video_path, num_frames=8)
    ...
    print(f"Sending 8 optimized images to {url}...")
...
if __name__ == "__main__":
    ...
    user_prompt = "Analyze these 8 sequential images. What is happening?"
